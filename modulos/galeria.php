                                ...
                                <div class="d-flex align-items-center row">
                                    ...
                                    <div class="mt-4 p-2 px-4">
                                        <form action="" method="POST" enctype="multipart/form-data" id="upload_fotos">
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-block shadow" value="Upload" style="width: 100%;color:#fff;background:#696cff">
                                            </div>

                                        </form>
                                        <div class="thumb">
                                            <div class="img-fluid parent-container" style="display: flex;" id="images_preview">
                                            </div>
                                        </div>
                                    </div>
                                </div>
