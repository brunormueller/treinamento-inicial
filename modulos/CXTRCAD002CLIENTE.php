                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-center row">
                                        ...
                                        <form action="" class="needs-validation user p-5" method="POST" id="form_cliente">
                                            <div class="form-group row mb-3">
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="">Nome</label>
                                                    <input type="text" id="nome_cliente" name="nome_cliente" class="form-control form-control-user obrigatorios" required>
                                                    <div class="invalid-feedback">Preencha o campo!</div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <label for="">CPF</label>
                                                    <input type="text" id="cp_cliente" name="cpf_cliente" class="form-control form-control-user obrigatorios" oninput="mascara(this)" required>
                                                    <div class="invalid-feedback">Preencha o campo!</div>
                                                </div>
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                            ...
                                            <div class="form-group row mb-3 mb-sm-3">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="email" id="email_cliente" name="email_cliente" class="form-control form-control-user obrigatorios" required>
                                                    <div class="invalid-feedback">Preencha o campo!</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <button @click="cadastrarForm()" type="submit" class="btn btn-primary btn-user btn-block" id="btnRegistrarClient" style="width: 100%;">Salvar</button>
                                                </div>
