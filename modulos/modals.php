<div class="modal fade" id="ModalEditarCliente" style="z-index: 999999999" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="confirma_editar_cliente" class="btn btn-success">Confirmar <i
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="confirma_desativar" class="btn btn-success">Confirmar <i class="fa fa-check"
                        aria-hidden="true"></i></button>
            </div>
        </div>
