...
<body>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block"><?php echo $nome_usuario ?></span>
                                                    <small class="text-muted"><?php echo $nome_perfil ?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-center row">
                                        <!-- <div class="col-sm-9 "> -->
                                        <form method="post" id="form-edit" class="needs-validation " enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-8 offset-md-2 ">
                                                    <h4 style="font-size:30px;" align="center" class="pt-3"> Precisando de ajuda? Nos envie um email</h4>
                                                    <div class="form-group">
                                                        <label>Nome</label>
                                                        <input autocomplete="off" type="text" name="name" placeholder="Digite seu nome" class="form-control obrigatorios" required />
                                                        <div class="invalid-feedback">Preencha o campo!</div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="mt-1">Email</label>
                                                        <input type="email" name="email" class="form-control obrigatorios" placeholder="Digite seu email" autocomplete="off" required />
                                                        <div class="invalid-feedback">Preencha o campo!</div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="mt-1">Assunto</label>
                                                        <input autocomplete="off" type="assunto" name="assunto" class="form-control obrigatorios" placeholder="Digite o assunto" required />
                                                        <div class="invalid-feedback">Preencha o campo!</div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="mt-1">Descrição</label>
                                                        <textarea name="additional_information" placeholder="Insira sua descrição" class="form-control obrigatorios" required rows="4"></textarea>
                                                        <div class="invalid-feedback">Preencha o campo!</div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="mt-1">Selecione um ou vários documentos</label>
                                                        <input type="file" name="uploaded_file[]" class="form-control" multiple="multiple" id="uploaded_file" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-2" align="center">
                                                <input type="submit" id="envio_email" name="submit" value="Enviar" class="btn btn-success w-25 shadow" />
                                            </div>
                                        </form>
                                    </div>
    ...
    <script src="js/consultas/CXTRCAD001CON/CXTRCAD002CLIENTECAD.js?time=<?php echo time(); ?>"></script>
