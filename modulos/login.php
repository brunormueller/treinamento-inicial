      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-4">Por favor insira seu login para continuar</p>

            <form id="formAuthentication" class="mb-3" method="POST">
              <div class="mb-3">
                <label for="usuario" class="form-label">Usuário</label>
                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Insira seu usuário" autofocus />
              </div>
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" id="enviar" name="enviar">Entrar</button>
              </div>
            </form>
