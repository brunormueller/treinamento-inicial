...
<html
  ...
  data-assets-path="vendor/assets/"
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Digite seu email e senha atual, após isso, é só informar a nova que deseja.</p>
              <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100">Trocar de Senha</button>
              </form>
